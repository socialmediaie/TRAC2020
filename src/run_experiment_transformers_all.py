...
def load_and_cache_examples(args, tokenizer, file_key="train"):
    ...
    if os.path.exists(cached_features_file):
        ...
        label_list = processor.get_labels()
        if args.model_type in ["roberta", "xlmroberta"]:
            label_list[1], label_list[2] = label_list[2], label_list[1]
        #features = glue_convert_examples_to_features(examples, tokenizer, max_length = args.max_seq_length, label_list, output_mode,
